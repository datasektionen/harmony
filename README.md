...
> [!WARNING]
> The information above may be outdated if this README has not been updated for a while, therefore the only reliable way to gain an understanding of the verification system is by reading the source code.
