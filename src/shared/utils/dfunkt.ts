...
export async function getIdentifierMandateRoleCurrent(identifier:string):Promise<RoleMandates> {
    try {
        const response = await fetch(dfunktEndpoint + 'api/role/' + identifier + '/current');
        if (!response.ok) {
            throw new Error('Network response was not ok');
        }
        const data: RoleMandates = await response.json();  
 ...
 * @param id The role id. 
 */
export async function getIdMandateRoleCurrent(id:number):Promise<RoleMandates> {
    try {
        const response = await fetch(dfunktEndpoint + 'api/role/id/' + id + '/current');
        if (!response.ok) {
            throw new Error('Network response was not ok');
        }
        const data: RoleMandates = await response.json();  
...
export async function getRolesByGroupId(groupid:string):Promise<Roles> {
    try {
        const response = await fetch(dfunktEndpoint + 'api/roles/type/' + groupid + '/all');
        if (!response.ok) {
            throw new Error('Network response was not ok');
        }
        const data: Roles = await response.json(); 
...
export async function getCurrentRolesByGroupId(groupid:string):Promise<Roles> {
    try {
        const response = await fetch(dfunktEndpoint + 'api/roles/type/' + groupid + '/all/current');
        if (!response.ok) {
            throw new Error('Network response was not ok');
        }
        const data: Roles = await response.json(); 
...
export async function getKthUserCurrentMandates(kthid:string):Promise<UserMandates> {
    try {
        const response = await fetch(dfunktEndpoint + 'api/user/kthid/' + kthid + '/current');
        if (!response.ok) {
            throw new Error('Network response was not ok');
        }
...
export async function getKthUserMandates(kthid:string):Promise<UserMandates> {
    try {
        const response = await fetch(dfunktEndpoint + 'api/user/kthid/' + kthid);
        if (!response.ok) {
            throw new Error('Network response was not ok');
        }
        const data: UserMandates = await response.json(); 
...
export async function getUgkthUserCurrentMandates(ugkthid:string):Promise<UserMandates> {
    try {
        const response = await fetch(dfunktEndpoint + 'api/user/ugkthid/' + ugkthid + '/current');
        if (!response.ok) {
            throw new Error('Network response was not ok');
        }
        const data: UserMandates = await response.json(); 
...
export async function getUgkthUserMandates(ugkthid:string):Promise<UserMandates> {
    try {
        const response = await fetch(dfunktEndpoint + 'api/user/ugkthid/' + ugkthid);
        if (!response.ok) {
            throw new Error('Network response was not ok');
        }
        const data: UserMandates = await response.json(); 
