import { UserMandates, RoleMandates, Roles, Users, User, Role, Group, Mandate } from "./dfunk-interfaces";
...
type DfunkInterface = User | Role | Group | Mandate | Roles | RoleMandates | UserMandates | Users;

async function dfunkAPICall(url: string, arg: string | null): Promise<DfunkInterface> {
 ...
 */
export async function getIdentifierMandateRole(identifier: string): Promise<RoleMandates> {
	return await dfunkAPICall(APIUrls.getIdentifierMandateRole, identifier) as RoleMandates;
}
/**
 * Sends an API call to dfunkt.se to get the role and its current mandates, given its identifier.
 * @param identifier The role identifier.
 */
export async function getIdentifierMandateRoleCurrent(identifier: string): Promise<RoleMandates> {
	return await dfunkAPICall(APIUrls.getIdentifierMandateRoleCurrent, identifier) as RoleMandates;
}
/**
 ...
 * @param id The role id.
 */
export async function getIdMandateRoleCurrent(id: string): Promise<RoleMandates> {
	return await dfunkAPICall(APIUrls.getIdMandateRoleCurrent, id) as RoleMandates;
}
/**
 ...
 * @param groupid The KTH:id of user.
 */
export async function getCurrentRolesByGroupId(groupid: string): Promise<Roles> {
	return await dfunkAPICall(APIUrls.getCurrentRolesByGroupId, groupid) as Roles;
}
 ...
 */
export async function getKthUserCurrentMandates(kthid: string): Promise<UserMandates> {
	return await dfunkAPICall(APIUrls.getKthUserCurrentMandates, kthid) as UserMandates;
}
/**
...
export async function getKthUserMandates( kthid: string): Promise<UserMandates> {
	return await dfunkAPICall(APIUrls.getKthUserMandates, kthid) as UserMandates;
}
/**
 * Sends an API call to dfunkt.se to get a user and their current mandates.
 * @param kthid The KTH:id of user.
 */
export async function getUgkthUserCurrentMandates( ugkthid: string): Promise<UserMandates> {
	return await dfunkAPICall(APIUrls.getUgkthUserCurrentMandates, ugkthid) as UserMandates;
}
/**
 * Sends an API call to dfunkt.se to get a user and all their mandates ever.
 * @param kthid The KTH:id of user.
 */
export async function getUgkthUserMandates( ugkthid: string): Promise<UserMandates> {
	return await dfunkAPICall(APIUrls.getUgkthUserMandates, ugkthid) as UserMandates;
}