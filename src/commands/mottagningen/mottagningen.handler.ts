...
import { handleMottagningenRmGroups } from "./subcommands/rmgroups/mottagningen-rmgroups.handler";
...
export async function handleMottagningen(
	...
	switch (subcommandName) {
		...
		case MottagningenSubcommands.RMGROUPS:
			return await handleMottagningenRmGroups(interaction);
		default:
