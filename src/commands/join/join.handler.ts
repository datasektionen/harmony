...
export const handleJoin = async (
	...
	const courseCode = options.getString(JoinVariables.COURSE_CODE, true).trim().toLowerCase();
	...
	const channel = interaction.guild?.channels.cache.find(({name}) => name === courseCode)
